(function(){
    nls.set('brx.AuthForm', {
       ...
       'message_signed_up': 'Registration successfully completed. We\'ve sent you an e-mail with credentials for your account.',
       'message_error_sign_up_failed': 'Error: registration failed',
       'message_spinner_validating_email': 'Validating e-mail address...',
       'message_change_pass_code_sent': 'We\'ve sent you an e-mail with password reset link. Please follow that link to set new password.',
