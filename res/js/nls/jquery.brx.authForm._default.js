(function(){
    nls.set('brx.authForm', {
       ...
       'message_signed_up': 'Регистрация прошла успешно, вам отправлено письмо, содержащие пароль, для входа на сайт.',
       'message_error_sign_up_failed': 'Ошибка: регистрация не выполнена',
       'message_spinner_validating_email': 'Проверка адреса e-mail...',
       'message_change_pass_code_sent': 'Вам отправлено письмо со ссылкой для смены пароля. Чтобы сменить пароль, перейдите по ссылке в письме.',
